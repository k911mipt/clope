...
import { ITransactionStore, ITransactionStoreIterator, Transaction, TransactionElement, UID } from "./Typings";

export default class Display {
    private dataSource: ITransactionStoreIterator;
    ...
    constructor(columnNumber: number, dataSource: ITransactionStoreIterator, tableClusters: number[]) {
